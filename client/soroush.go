...
func handleRequestOTP(w http.ResponseWriter, r *http.Request) {
	...
	// We'll also allow a special code 13651 as a bypass code if the user forgets
	...
	json.NewEncoder(w).Encode(map[string]interface{}{
		"success":     true,
		"phoneNumber": req.PhoneNumber,
		"message":     "OTP requested successfully. Please check the Signaling & P2P Routing Logs to retrieve your PIN code!",
	})
}
...
func handleVerifyOTP(w http.ResponseWriter, r *http.Request) {
	...
	// Check OTP: Allow the generated code or a standard helper code "13651"
